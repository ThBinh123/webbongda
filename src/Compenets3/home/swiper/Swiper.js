    ...
    return (
        ...
        >
            ...
            <SwiperSlide className='box-swiper'>
                ...
                <Link to="/SanPham/Giay/3" className='linkswiper'><h5>Giày Bóng Đá Adidas-Copa</h5></Link>
            </SwiperSlide>
            <SwiperSlide className='box-swiper'>
                <img src={imagehot2} style={{width:"100%",height:"280px"}}  ></img>
                <Link to="/SanPham/Giay/4" className='linkswiper'><h5>Giày PUMA Trắng</h5></Link>
            </SwiperSlide>
            <SwiperSlide className='box-swiper'>
                <img src={imagehot3}  style={{width:"100%",height:"280px"}}></img>
                <Link to="/SanPham/Giay/9" className='linkswiper'><h5>Giày Adidas Không Dây Xanh</h5></Link>
            </SwiperSlide>
            <SwiperSlide className='box-swiper'>
                <img src={imagehot4} style={{width:"100%",height:"280px"}}></img>
                <Link to="/SanPham/Giay/12" className='linkswiper'><h5>Giày Tiempo</h5></Link>
            </SwiperSlide>
            <SwiperSlide className='box-swiper'>
                <img src={imagehot5}  style={{width:"100%",height:"280px"}}></img>
                <Link to="/SanPham/Giay/11" className='linkswiper'><h5>Giày CR7</h5></Link>
            </SwiperSlide>
